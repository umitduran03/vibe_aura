...
const privacyData = {
  en: {
    ...
    s2_1L1: "We use Google Authentication for sign-in. We collect and store your Email address, Name, Profile Photo, and a unique User ID (UID). This allows us to maintain your account, track your token balance, and provide features like Daily Vibe and Duo Match.",
    s2_1L2: "Optional input used to tailor and personalize AI-generated entertainment content.",
    s2_1L3: "If you choose to upload a photo for analysis, the image is processed temporarily for the AI analysis and is ",
    ...
    s3Title: "3. Photos & Images",
    s3Warn: "🔒 We do <strong>NOT</strong> store, sell, share, or use your photos for any purpose beyond the immediate AI analysis you request.",
    s3Desc: "Photos uploaded for personality analysis are processed in real-time by our AI models and are discarded immediately after the analysis is generated. We do not retain copies of your images on any server. We never sell or share your images with third parties, advertisers, or data brokers.",
    s4Title: "4. How We Use Your Data",
    s4L1: "To provide core features like Daily Vibe, Duo Match, and generate personalized personality analyses.",
    ...
    s5Post: "Each service has its own privacy policy. We encourage you to review them independently.",
  ...
  tr: {
    ...
    s2_1L1: "Giriş yapmak için Google kullanıyoruz. E-posta adresini, adını, profil fotoğrafını ve sana özel bir kullanıcı kimliğini (UID) kaydediyoruz. Bu sayede hesabını yönetebiliyor, token bakiyeni tutabiliyor ve Daily Vibe, Duo Match gibi özellikleri sana sunabiliyoruz.",
    s2_1L2: "Yapay zeka analizlerini sana özel hale getirmek için girdiğin burç, yaş veya ilişki durumu gibi ekstra bilgiler.",
    s2_1L3: "Analiz için bir fotoğraf yüklersen, bu görsel yapay zeka tarafından anlık olarak işlenir ve ",
    ...
    s3Title: "3. Fotoğraflar ve Görseller (Önemli!)",
    s3Warn: "🔒 Fotoğraflarını analiz bittikten sonra ASLA saklamayız, satmayız veya başka hiçbir amaçla kullanmayız.",
    s3Desc: "Kişilik analizi için yüklediğin fotoğraflar yapay zeka modellerimiz tarafından o an işlenir ve sonuç çıkar çıkmaz anında silinir. Sunucularımızda fotoğraflarının bir kopyasını tutmuyoruz. Görsellerini reklamcılarla veya üçüncü şahıslarla asla paylaşmıyoruz.",
    s4Title: "4. Verilerini Ne İçin Kullanıyoruz?",
    s4L1: "Daily Vibe ve Duo Match gibi ana özellikleri çalıştırmak ve sana özel analizler üretmek için.",
    ...
    s5Post: "Bu servislerin kendi gizlilik politikaları vardır, istersen onların sitelerinden detaylıca inceleyebilirsin.",
