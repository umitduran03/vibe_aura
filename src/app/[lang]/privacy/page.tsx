...
const privacyData = {
  en: {
    ...
    s4L1: "To provide core features like Daily Vibe, Duo, and generate personalized personality analyses.",
  ...
  tr: {
    ...
    s4L1: "Daily Vibe ve Duo gibi ana özellikleri çalıştırmak ve sana özel analizler üretmek için.",
