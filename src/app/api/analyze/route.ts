...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const tokenCost = mode === "duo" ? 3 : mode === "extras" ? (body.extrasType === "delulu-check" ? 7 : body.extrasType === "situationship" ? 5 : body.extrasType === "rizz-architect" ? 2 : body.extrasType === "profile-autopsy" ? 8 : 3) : 1;
