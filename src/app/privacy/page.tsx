          ...
          <section>
            ...
            <ul className="space-y-2 list-none">
              <li className="flex gap-2">
                ...
                <span><strong className="text-white/90">Authentication & Profile Data:</strong> We use Google Authentication for sign-in. We collect and store your Email address, Name, Profile Photo, and a unique User ID (UID). This allows us to maintain your account, track your token balance, and provide features like Daily Vibe and Duo Match.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-cyan-400 mt-1">•</span>
                <span><strong className="text-white/90">Zodiac Sign, Age & Relationship Status:</strong> Optional input used to tailor and personalize AI-generated entertainment content.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-cyan-400 mt-1">•</span>
            ...
            <h3 className="text-[15px] font-medium text-white/80 mt-4 mb-2">2.2 Automatically Collected Data (Limited)</h3>
            <ul className="space-y-2 list-none">
              <li className="flex gap-2">
                <span className="text-cyan-400 mt-1">•</span>
                <span><strong className="text-white/90">Security Data (Firebase App Check):</strong> We use Firebase App Check (which may include reCAPTCHA) to protect our backend from abuse and verify legitimate traffic.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-cyan-400 mt-1">•</span>
                <span><strong className="text-white/90">Device FCM Token:</strong> If you opt in to push notifications, your device token is stored to deliver notifications.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-cyan-400 mt-1">•</span>
                <span><strong className="text-white/90">Usage Analytics:</strong> We may use Firebase Analytics to collect anonymized usage statistics (e.g., feature popularity, crashes) to improve the App.</span>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-2 list-none">
              <li className="flex gap-2">
                ...
                <span>To provide core features like Daily Vibe, Duo Match, and generate personalized personality analyses.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-purple-400 mt-1">→</span>
              ...
              <li className="flex gap-2">
                <span className="text-purple-400 mt-1">→</span>
                <span>To secure our application and verify authentic traffic using Firebase App Check.</span>
              </li>
              <li className="flex gap-2">
                <span className="text-purple-400 mt-1">→</span>
