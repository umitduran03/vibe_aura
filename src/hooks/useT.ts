...
const STRINGS = {
  ...
  tr: {
    ...
    onboardingBannerStep1Title: "Ben bir...",
    onboardingBannerGuy: "Erkeğim 🧢",
    onboardingBannerGirl: "Kızım 💅",
    onboardingBannerIcon: "İkonum ✨",
    onboardingBannerStep2Title: "Genelde şunları kafaya takarım...",
    onboardingBannerGuys: "Erkekleri 🚩",
    onboardingBannerGirls: "Kızları ☕",
