...
const STRINGS = {
  en: {
    ...
    analyzingDuoBattle: ["JUDGING THE AURAS...", "COMPARING MAIN CHARACTER ENERGY...", "FINDING THE WEAK LINK...", "PREPARING THE ROAST...", "DECIDING THE WINNER..."],
    ...
    duoP1AgeTitle: "AGE",
    duoP2AgeTitle: "AGE",
    duoMagicTitle: "Anything I should know?",
    duoMagicHint: "Optional — but the more tea you spill, the better the result.",
    duoMagicPlaceholder: "Optional — e.g., We broke up 3 times, he stalks his ex...",
    duoRelation: "Analysis Type",
    duoFlirt: "Flirt / Lovers",
    duoEx: "Ex-Lovers",
    duoPlatonic: "Platonic / Crush",
    duoBff: "BFF / Partner in Crime",
    duoBattle: "Aura Battle ⚔️",
    ...
    resultShareText: "My vibe score: {score}/100 💜\nTry it yourself! 👀 👉 https://thevibecheckr.com",
    resultDuoSoulmate: "Duo Analysis",
    resultRedFlag: "Red Flag",
    resultBattleVerdict: "Battle Verdict (Loser)",
  ...
  tr: {
    ...
    analyzingDuoBattle: ["AURALAR ÇARPIŞIYOR...", "ANA KARAKTER ENERJİSİ ÖLÇÜLÜYOR...", "ZAYIF HALKA BULUNUYOR...", "GÖMME İŞLEMİ BAŞLIYOR...", "KAZANAN BELİRLENİYOR..."],
    ...
    duoP1AgeTitle: "YAŞI",
    duoP2AgeTitle: "YAŞI",
    duoMagicTitle: "Bilmem gereken bir şey var mı?",
    duoMagicHint: "Opsiyonel — ama ne kadar dedikodu verirsen sonuç o kadar isabetli olur.",
    duoMagicPlaceholder: "Opsiyonel — örn: 3 kere ayrıldık, eski sevgilisini unutamadı...",
    duoRelation: "Analiz Türü",
    duoFlirt: "Flört / Sevgili",
    duoEx: "Eski Sevgili",
    duoPlatonic: "Platonik / Crush",
    duoBff: "En Yakın Arkadaş",
    duoBattle: "Vibe Savaşı ⚔️",
    ...
    resultShareTitle: "{name} — VibeCheckr",
    resultShareText: "Vibe puanım: {score}/100 💜\nSen de dene! 👀 👉 https://thevibecheckr.com",
    resultDuoSoulmate: "Duo Analiz",
    resultRedFlag: "Red Flag (Kırmızı Bayrak)",
    resultBattleVerdict: "Savaş Sonucu (Kaybeden)",
