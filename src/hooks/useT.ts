...
const STRINGS = {
  en: {
    ...
    onboardingTerms: "Terms",
    onboardingPrivacy: "Privacy",
    ...
    analyzingRizzArchitect: ["ANALYZING TEXTS...", "CALCULATING RIZZ...", "DETECTING CRINGE...", "CRAFTING PERFECT REPLY...", "PREPARING TO SEND..."],
    analyzingProfileAutopsy: ["SCANNING PROFILE...", "JUDGING AESTHETICS...", "DETECTING RED FLAGS...", "ANALYZING BIOS...", "PREPARING THE AUTOPSY..."],
    ...
    analyzingDuoBff: ["SCANNING CHAOS LEVELS...", "MEASURING GOSSIP SYNERGY...", "ANALYZING PARTNER IN CRIME DYNAMICS...", "CHECKING MUTUAL TOXICITY...", "CALCULATING BFF SCORE..."],
    ...
    resultShareTitle: "I got '{name}' on VibeCheckr 💀",
    resultShareText: "My vibe score: {score}/100 ✨\nAI called me '{name}' — what does it call YOU?\n👉 thevibecheckr.com",
    resultShareTextNoScore: "AI called me '{name}' — what does it call YOU?\n👉 thevibecheckr.com",
    resultShareTitleOther: "AI evaluated this profile on VibeCheckr 💀",
    resultShareTextOther: "Vibe score: {score}/100 ✨\nAI called this profile '{name}' — what does it call yours?\n👉 thevibecheckr.com",
    resultShareTextOtherNoScore: "AI called this profile '{name}' — what does it call yours?\n👉 thevibecheckr.com",
    resultChallengeBtn: "🥊 Challenge a Friend",
    resultChallengeDuoBtn: "🔁 Try Another Combo",
    resultDuoSoulmate: "Duo Analysis",
    resultRedFlag: "Red Flag",
    resultBattleVerdict: "Battle Verdict (Loser)",
    resultDuoShareText: "Our duo vibe score: {score}/100 💔\nAI just exposed our whole dynamic 👀\n👉 thevibecheckr.com",
    ...
    // Web/Mobile Consent Modal
    consentTitle: "We Need to Be Honest With You...",
  ...
  tr: {
    ...
    onboardingTerms: "Şartlar",
    onboardingPrivacy: "Gizlilik",
    ...
    analyzingRizzArchitect: ["MESAJLAR ANALİZ EDİLİYOR...", "RİZZ SEVİYESİ HESAPLANIYOR...", "CRINGE UYARISI TARANIYOR...", "MÜKEMMEL CEVAP HAZIRLANIYOR...", "GÖNDERMEYE HAZIRLIK..."],
    analyzingProfileAutopsy: ["PROFİL TARANIYOR...", "ESTETİK YARGILANIYOR...", "RED FLAG'LER ARANIYOR...", "BİYOGRAFİ ÇÖZÜMLENİYOR...", "OTOPSİ RAPORU HAZIRLANIYOR..."],
    ...
    analyzingDuoBff: ["KAOS SEVİYESİ TARANIYOR...", "DEDİKODU UYUMU ÖLÇÜLÜYOR...", "SUÇ ORTAKLIĞI ANALİZ EDİLİYOR...", "BİRBİRİNİZE NE KADAR TOKSİKSİNİZ HESAPLANIYOR...", "KANKA SKORU BELİRLENİYOR..."],
    ...
    resultShareTitle: "Yapay zeka bana '{name}' dedi 💀",
    resultShareText: "Vibe puanım: {score}/100 ✨\nYapay zeka bana '{name}' dedi — sana ne diyecek?\n👉 thevibecheckr.com",
    resultShareTextNoScore: "Yapay zeka bana '{name}' dedi — sana ne diyecek?\n👉 thevibecheckr.com",
    resultShareTitleOther: "Yapay zeka bu profile '{name}' dedi 💀",
    resultShareTextOther: "Vibe puanı: {score}/100 ✨\nYapay zeka bu profile '{name}' dedi — seninkine ne diyecek?\n👉 thevibecheckr.com",
    resultShareTextOtherNoScore: "Yapay zeka bu profile '{name}' dedi — seninkine ne diyecek?\n👉 thevibecheckr.com",
    resultChallengeBtn: "🥊 Arkadaşına Meydan Oku",
    resultChallengeDuoBtn: "🔁 Başka Bir İkili Dene",
    resultDuoSoulmate: "Duo Analiz",
    resultRedFlag: "Red Flag (Kırmızı Bayrak)",
    resultBattleVerdict: "Savaş Sonucu (Kaybeden)",
    resultDuoShareText: "Duo vibe puanımız: {score}/100 💔\nYapay zeka tüm dinamiğimizi ifşa etti 👀\n👉 thevibecheckr.com",
    ...
    // Web/Mobile Consent Modal
    consentTitle: "Sana Karşı Dürüst Olmalıyız...",
